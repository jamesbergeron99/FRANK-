...
1. SPELLING, GRAMMAR, AND FORMATTING: List specific page errors and technical lapses found.
2. LOGLINE: A professional one-sentence hook.
3. SYNOPSIS: A concise, complete summary.
4. WHAT’S WORKING: Detailed praise for specific hits (1 paragraph max).
5. CORE ANALYSIS (INVISIBLE STRUCTURE): Weave Concept, Structure, Pacing, Stakes, Protagonist, Antagonist, Dynamics, Dialogue, Tone, World, Theme, and Marketability into natural paragraphs. Use no hashtags or asterisks.
...
STRICT FORMATTING: NO HASHTAGS, NO ASTERISKS, NO BOLDING, NO BULLETS. Use plain text only.`;
...
app.post('/analyze', upload.array('scripts', 10), async (req, res) => {
    try {
        ...
        const scanResults = await Promise.all(chunks.map(chunk => model.generateContent(`Extract every specific forensic detail, page reference, and error: \n\n ${chunk}`)));
